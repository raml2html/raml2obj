...
describe('raml2obj', () => {
  describe('secured-by.raml', () => {
    ...
    before((done) => {
      raml2obj.parse('test/secured-by.raml').then((result) => {
        obj = result;
        done();
      }, (error) => {
    ...
    it('should make securedBy consistent', () => {
      ...
      assert.strictEqual(B.methods[0].securedBy[0], Object(B.methods[0].securedBy[0]));
      ...
      assert.strictEqual(B.methods[1].securedBy[0], Object(B.methods[1].securedBy[0]));
